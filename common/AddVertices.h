...
class AddVertices
{
	public:
		...
		inline htr::Point3D get_centroid(){ return originalPoints_centroid; }
		inline vector<htr::Point3D> get_original(){ return originalPoints; }
		inline vector<htr::Point3D> get_added(){ return added_points; }
		inline vector<htr::Point3D> get_all(){ return all_points; }
		inline vector<pcl::PointXYZ> get_point_cloud(){ return pcl_point_cloud; }
	...
	private:
		...
		vector<pcl::PointXYZ>	pcl_point_cloud;
